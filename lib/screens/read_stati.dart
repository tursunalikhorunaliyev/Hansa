...
class ReadStati extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final blocForStatiComment = BlocForStatiComment(statiId, token);
    blocForStatiComment.evsink.add(StatiComentEnum.coment);
    log(statiId.getIndex);
    log(token);
                            ...
                            StreamBuilder<StatiComentModel>(
                                ...
                                builder: (context, snapshota) {
                                  if (snapshota.hasData) {
                                    ...
                                    BlocForStatiComment(statiId, token);
                                    blocForStatiComment.evsink
                                        .add(StatiComentEnum.coment);
                                    return Center(
                                      child: Lottie.asset(
                                        'assets/pre.json',
                                        height: 70,
